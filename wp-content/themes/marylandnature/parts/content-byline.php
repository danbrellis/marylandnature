<p class="byline">
	...
	<?php echo is_singular('event') ? false : ($post->post_type == 'event' ? nhsm_get_date_range($post) : '<time>' . get_the_time('F j, Y') . '</time>'); ?><?php if ( comments_open() ): ?>&nbsp;<span class="middot">&middot;</span>&nbsp;
